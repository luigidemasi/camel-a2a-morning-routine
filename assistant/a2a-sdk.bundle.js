(() => {
  ...
  var JsonRpcTransport = class _JsonRpcTransport {
    constructor(options) {
      __publicField(this, "customFetchImpl");
  ...
  var _a;
  var JsonRpcTransportFactory = (_a = class {
    constructor(options) {
  ...
  }, __publicField(_a, "name", "JSONRPC"), _a);
  ...
  var Client = class {
    ...
    applyClientConfig({
      ...
      (_a3 = result.configuration).blocking ?? (_a3.blocking = blocking);
      return result;
    }
  ...
  var _a2;
  var RestTransportFactory = (_a2 = class {
    constructor(options) {
      this.options = options;
    }
    get protocolName() {
  ...
  }, __publicField(_a2, "name", "HTTP+JSON"), _a2);
  ...
  var ClientFactory = class {
    constructor(options = ClientFactoryOptions.default) {
      __publicField(this, "transportsByName");
      __publicField(this, "agentCardResolver");
      this.options = options;
